<!-- <link rel="stylesheet" href="/css/style_card_sne.css"> -->
<x-layout title="Sobre nos">
    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img class="antonio rounded-circle" src="{{URL::to('/assets/img/FotoAntonioCasualGroupe.jpg')}}" alt="antonio" style="margin-right: 1rem;">
              <div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4" style="margin-bottom: 1rem;">
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img class="carlos rounded-circle" src="{{URL::to('/assets/img/FotoCarlitosParaCasualGroup.jpg')}}" alt=".carlos" style="margin-right: 1rem;">
              <div>
    ...
    <div class="row justify-content-center">
      <div class="col-sm-12 col-md-6 col-lg-4" style="margin-bottom: 1rem;">
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img class="thiago rounded-circle" src="{{URL::to('/assets/img/FotoDoThigasDoCasualGroup.jpg')}}" alt=".thiago" style="margin-right: 1rem;">
              <div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4" style="margin-bottom: 1rem;">
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img class="juarez rounded-circle " src="{{URL::to('/assets/img/FotoJuarezCasualGroup.jpg')}}" alt=".juarez" style="margin-right: 1rem;">
              <div>
