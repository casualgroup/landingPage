    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img class="antonio rounded-circle" src="{{asset('img/FotoAntonioCasualGroupe.jpg')}}" alt="antonio" style="margin-right: 1rem;">
              <div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4" style="margin-bottom: 1rem;">
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img class="carlos rounded-circle" src="{{asset('img/FotoCarlitosParaCasualGroup.jpg')}}" alt=".carlos" style="margin-right: 1rem;">
              <div>
    ...
    <div class="row justify-content-center">
      <div class="col-sm-12 col-md-6 col-lg-4" style="margin-bottom: 1rem;">
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img class="thiago rounded-circle" src="{{asset('img/FotoDoThigasDoCasualGroup.jpg')}}" alt=".thiago" style="margin-right: 1rem;">
              <div>
      ...
      <div class="col-sm-12 col-md-6 col-lg-4" style="margin-bottom: 1rem;">
        <div class="card">
          <div class="card-body">
            <div class="d-flex align-items-center">
              <img class="juarez rounded-circle " src="{{asset('img/FotoJuarezCasualGroup.jpg')}}" alt=".juarez" style="margin-right: 1rem;">
              <div>
