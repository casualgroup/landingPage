                    ...
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Nome" name="Nome" placeholder="Ex: Thiago">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="Sobrenome" name="Sobrenome" placeholder="Ex: Banks">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="email" name="email" placeholder="Ex: casualGroup@gmail.com">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mb-3">
                            <div class="form-group">
                                ...
                                <input type="tel" class="form-control" id="Numero" name="Numero" placeholder="Ex: (00)0000-0000">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="Mensagem" name="Mensagem" rows="4" placeholder="Escreva aqui sua mensagem..."></textarea>
                            </div>
                        </div>
